if (navigator.geolocation) {
  navigator.geolocation.getCurrentPosition(position => {
      ...
      // Draggaber function marker
      function addDragrableMarker(map, behavior) {
              ...
              // disable the default draggability of the underlying map and
              ...
              // re-enable the default draggabiity of underlying map
      ...
      if (window.action == "submit") {
        addDragrableMarker(map, behavior);
      }

      // Browse location codepace
      let spaces = [];
      ...
      if (window.action == 'browse') {
        map.addEventListener('dragend', function(ev) {
          ...
          inti(resultCoord.lat, resultCoord.lng, 40);
        }, false);
    ...
    console.error("Geolocation is not support this browser.")
}